...
SOURCE_IMAGE = 'akseutap5registry.azurecr.io/elephants'
LOCAL_PATH = os.getenv("LOCAL_PATH", default='.')
NAMESPACE = 'micropets-dev'
K8S_TEST_CONTEXT = os.getenv("K8S_TEST_CONTEXT", default='aks-eu-tap-5')
...
k8s_custom_deploy(
    ...
    apply_cmd="tanzu apps workload apply -f config/workload.yaml --live-update" +
        ...
        " --namespace " + NAMESPACE +
        " --yes >/dev/null" +
        " && kubectl get workload elephants-nodejs-mongodb --namespace " + NAMESPACE + " -o yaml",
